...
export class Layout extends BasePage {
  ...
  constructor(page: Page) {
    ...
    this.gitHubLink = page.locator("app-footer .container-fluid").getByText("GitHub repo");
    this.policyLink = page.locator("app-footer .container-fluid").getByText("Privacy Policy");
